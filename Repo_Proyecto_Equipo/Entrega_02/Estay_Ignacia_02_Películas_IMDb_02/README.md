...
Lamentablemente, al momento de combinar se desorganizó el orden que tenía la base de Constanza en un inicio, donde estaba ordenado por categoría femenina/masculina y luego de la combinación entre ambas base las dos categorias se mezclaron. Más adelante se ordenará de la forma más conveniente para seguir trabajando.
